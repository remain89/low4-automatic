	...
	for i in range(0,data6.MeterID.count()):
		...
		for j in range(0,data7.CTime.count()):		
			...
			if check>0:
				...
				if kk==-1 :
					data10=data8[data8['FEP']>9000000]
				else :		   
					data10=data8[data8['FEP']>bvalue]
					data10=data10+data8[data8['FEP']<svalue]	 
					data10=data10+data8[data8['FEP']>9000000] #FEP의 쓰레기값 조건 범위 확인
		...
		for j in range(0,data7.CTime.count()):
			...
			if check>0:
				...
				if kk==-1 :
					...
					data10=data10+data8[data8['FEP']>9000000] #FEP의 쓰레기값 조건 범위 확인
					data10=data10+data8[data8['FEP']<0] #FEP의 쓰레기값 조건 범위 확인
					data10=data10+data8[data8['LARAP']>9000000]
					data10=data10+data8[data8['LARAP']<0]		 
					data10=data10+data8[data8['LERAP']>9000000]
					data10=data10+data8[data8['LERAP']<0]
					data10=data10+data8[data8['AP']>9000000]
	...
	for i in range(0,data6.MeterID.count()):
		...
		#  data8=data8.drop_duplicates('CTime',keep='first') # 시간 중복데이터 제거 
			...
			if check>0:
				...
				data10=data8[data8['APT1']>9000000] #FEP의 쓰레기값 조건 범위 확인
				data10=data10+data8[data8['APT1']<0] #FEP의 쓰레기값 조건 범위 확인
				data10=data10+data8[data8['APT2']>9000000]
				data10=data10+data8[data8['APT2']<0]		 
				data10=data10+data8[data8['RPT']>9000000]
				data10=data10+data8[data8['RPT']<0]
				data10=data10+data8[data8['LPT']>9000000]
...
#  data8=data8.drop_duplicates('CTime',keep='first') # 시간 중복데이터 제거 
			...
			if check>0:
				...
				data10=data8[data8['SAP']>9000000] #SAP의 쓰레기값 조건 범위 확인
	...
	for i in range(0,data6.MeterID.count()):
		for j in range(0,data7.CTime.count()):
			...
			if check>0:
				...
				data10=data8[data8['APT']>9000000]
				...
				data11=data9[data9['APT']>9000000]
				data11=data11+data9[data9['APT']<0]
				data11=data11+data9[data9['RPT']>9000000]
				data11=data11+data9[data9['RPT']>9000000]
	...
	for i in range(0,data6.MeterID.count()):
		...
		#  data8=data8.drop_duplicates('CTime',keep='first') # 시간 중복데이터 제거 
			...
			if check>0:
				...
				data10=data8[data8['AP']>9000000] #FEP의 쓰레기값 조건 범위 확인
				data10=data10+data8[data8['AP']<0] #FEP의 쓰레기값 조건 범위 확인
				data10=data10+data8[data8['TAP']>9000000]
	...
	for i in range(0,data6.MeterID.count()):
		for j in range(0,data7.CTime.count()):
			...
			if check>0:
				...
				data11=data9[data9['AP']>9000000] #FEP의 쓰레기값 조건 범위 확인
				data11=data11+data9[data9['AP']<0] #FEP의 쓰레기값 조건 범위 확인
				data11=data11+data9[data9['TAP']>9000000]
